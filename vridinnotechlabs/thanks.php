...
$SQLA ="insert into newsletterData
    (UserEmail)
    values
    ('".$email."')";
...
<html lang="en">
  <head>
    ...
    <title>VridInno Tech Labs | Touch Interactive Table, Touch Terminal, Digital Interative Application | Bangalore</title>
  </head>
  <body>
...
<section class="py-5 product-customer">
  <div class="container">
    ...
    <!-- <script src="assets/js/jquer-3.2.1.min.js"></script> -->
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
